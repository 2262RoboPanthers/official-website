...
export default function OpeningBanner({
  ...
  return (
    ...
    <section className="relative w-full min-h-[75dvh] flex flex-col justify-center items-center text-center px-4 overflow-hidden">
      ...
      />
      <section className="relative w-full py-16 px-4 sm:px-8 md:px-12 max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-40">
        {/* Logo Graphic Placeholder */}
        <div className="w-32 sm:w-64 flex items-center pt-0 sm:pt-16 flex-shrink-0 z-0">
          <img
            src="/icons/logo.svg"
            alt="Team Logo"
